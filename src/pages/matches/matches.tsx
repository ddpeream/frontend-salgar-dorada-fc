...
const matchesHistory: Match[] = [
  {
    ...
    awayTeam: "Atlético Nacional B",
    homeScore: 2,
    awayScore: 1,
    venue: "Unidad Deportiva de Belén",
    status: "finalizado",
    tournamentId: "liga-antioquia-2025",
  },
  {
    id: "match-2",
    date: "2025-09-14",
    time: "18:00",
    homeTeam: "Deportivo Pereira B",
  ...
  },
  {
    ...
    date: "2025-08-31",
    time: "19:00",
    homeTeam: "Deportivo Cali B",
    awayTeam: "Salgar Dorada FC",
    homeScore: 1,
    awayScore: 2,
    venue: "Estadio Deportivo Cali",
    status: "finalizado",
    tournamentId: "copa-nacional-2025",
  },
  {
    id: "match-5",
    date: "2025-09-15",
...
const upcomingMatches: Match[] = [
  {
    ...
    date: "2025-09-28",
    time: "15:30",
    homeTeam: "Independiente Medellín B",
    awayTeam: "Salgar Dorada FC",
...
const tournamentTables: Record<string, TableTeam[]> = {
  "liga-antioquia-2025": [
    { position: 1, name: "Atlético Nacional B", played: 12, won: 9, drawn: 2, lost: 1, goalsFor: 28, goalsAgainst: 8, goalDifference: 20, points: 29, tournamentId: "liga-antioquia-2025" },
    { position: 2, name: "Independiente Medellín B", played: 12, won: 7, drawn: 4, lost: 1, goalsFor: 22, goalsAgainst: 10, goalDifference: 12, points: 25, tournamentId: "liga-antioquia-2025" },
    { position: 3, name: "Salgar Dorada FC", played: 12, won: 6, drawn: 5, lost: 1, goalsFor: 18, goalsAgainst: 9, goalDifference: 9, points: 23, tournamentId: "liga-antioquia-2025" },
    { position: 4, name: "Envigado FC B", played: 12, won: 6, drawn: 3, lost: 3, goalsFor: 19, goalsAgainst: 14, goalDifference: 5, points: 21, tournamentId: "liga-antioquia-2025" },
    { position: 5, name: "Deportivo Pereira B", played: 12, won: 5, drawn: 4, lost: 3, goalsFor: 16, goalsAgainst: 13, goalDifference: 3, points: 19, tournamentId: "liga-antioquia-2025" },
    { position: 6, name: "La Equidad B", played: 12, won: 4, drawn: 5, lost: 3, goalsFor: 15, goalsAgainst: 14, goalDifference: 1, points: 17, tournamentId: "liga-antioquia-2025" },
    { position: 7, name: "Once Caldas B", played: 12, won: 3, drawn: 4, lost: 5, goalsFor: 12, goalsAgainst: 18, goalDifference: -6, points: 13, tournamentId: "liga-antioquia-2025" },
    { position: 8, name: "Deportivo Cali B", played: 12, won: 2, drawn: 3, lost: 7, goalsFor: 10, goalsAgainst: 21, goalDifference: -11, points: 9, tournamentId: "liga-antioquia-2025" },
  ],
  "copa-nacional-2025": [
    { position: 1, name: "Salgar Dorada FC", played: 6, won: 4, drawn: 2, lost: 0, goalsFor: 12, goalsAgainst: 4, goalDifference: 8, points: 14, tournamentId: "copa-nacional-2025" },
    { position: 2, name: "Deportivo Cali B", played: 6, won: 3, drawn: 2, lost: 1, goalsFor: 9, goalsAgainst: 6, goalDifference: 3, points: 11, tournamentId: "copa-nacional-2025" },
    { position: 3, name: "Once Caldas B", played: 6, won: 2, drawn: 1, lost: 3, goalsFor: 7, goalsAgainst: 9, goalDifference: -2, points: 7, tournamentId: "copa-nacional-2025" },
    { position: 4, name: "Millonarios B", played: 6, won: 1, drawn: 1, lost: 4, goalsFor: 5, goalsAgainst: 14, goalDifference: -9, points: 4, tournamentId: "copa-nacional-2025" },
  ],
